      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gold-50 flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Sign in to your Midas Technical Solutions account</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition-all duration-200"
            >
