...
// PS5 Parts Data - Real wholesale supplier data
const ps5Parts = [
  {
    id: 1,
  ...
  },
  {
    ...
    category: 'Cooling',
    price: 11.11,
    description: 'High-performance thermal putty for optimal heat transfer between APU and heatsinks',
    compatibility: 'PlayStation 5',
    supplier: 'MobileSentrix',
    featured: false,
    image: '/placeholder-ps5.jpg'
  },
  {
    ...
    category: 'Controller',
    price: 7.64,
    description: 'Rechargeable lithium-ion battery for DualSense controllers with extended playtime',
    compatibility: 'PlayStation 5',
    supplier: 'MobileSentrix',
    featured: false,
    image: '/placeholder-ps5.jpg'
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-yellow-500/10 border border-yellow-500/20 mb-8">
              <span className="text-yellow-400 text-sm font-medium">Premium PS5 Components</span>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-400">{ps5Parts.length}</div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12 p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
              <div>
                <h2 className="text-3xl font-bold text-slate-900 mb-2">
                  {selectedCategory === 'All' ? 'All PS5 Parts' : `${selectedCategory} Components`}
                </h2>
                ...
                >
                  ...
                  <div className="relative aspect-square bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-7xl opacity-15 group-hover:opacity-25 transition-opacity duration-300">⚙️</div>
                    </div>
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-3 rounded-xl hover:from-yellow-600 hover:to-yellow-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl hover:shadow-yellow-500/25 hover:-translate-y-0.5"
            ...
            {filteredAndSortedParts.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-slate-600 mb-8 max-w-md mx-auto">
                  Try adjusting your filters or browse our complete catalog of premium PS5 components.
                </p>
                <button
                  onClick={clearFilters}
                  className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-8 py-4 rounded-xl hover:from-yellow-600 hover:to-yellow-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl hover:shadow-yellow-500/25"
                >
                  View All Parts
                </button>
              </div>
